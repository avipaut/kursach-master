"""Add board_users association table

Revision ID: e848b5074310
Revises: f2f78867ee00
Create Date: 2025-04-24 18:28:28.174898
...
revision = 'e848b5074310'
down_revision = 'f2f78867ee00'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    with op.batch_alter_table('lobbies', schema=None) as batch_op:
        batch_op.create_foreign_key(
            'fk_lobbies_archived_by_users',  # имя внешнего ключа
            'users',
            ['archived_by'],
            ['id'],
            ondelete='SET NULL'
